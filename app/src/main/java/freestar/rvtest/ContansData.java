...
//        replay1.add(new CommentItem("权志龙", "韩国的教育有待改善!"));
        ...
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 11, 13, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-6", 15, goodjobs2, replay2));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 12, 14, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-7", 16, goodjobs3, replay3));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 13, 15, "教你如何买到特价机票，这个可以马住好好研究下-题外话：虽然这里面可以通过xml属性" +
        ...
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 14, 17, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-9", 18, goodjobs5, replay5));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 15, 18, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-10", 19, goodjobs6, replay6));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 16, 19, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-11", 20, goodjobs7, replay7));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 17, 20, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-12", 21, goodjobs8, replay8));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 18, 21, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-13", 22, goodjobs9, replay9));
        mList.add(new CircleItem("http://img.zcool.cn/community/018de756a3798c6ac7256cb087794d.jpg@900w_1l_2o_100sh.jpg", "Jack", 19, 22, "教你如何买到特价机票，这个可以马住好好研究下！", "2017-8-14", 23, goodjobs10, replay10));
        return mList;
    }
}
