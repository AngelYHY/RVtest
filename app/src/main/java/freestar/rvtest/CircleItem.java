...
//    }
    ...
    public CircleItem(String sImg, String sName, int sendNum, int acceptNum, String sContent, String sTime, int farNum, List<FavortItem> goodjobs, List<CommentItem> replys) {
    ...
    public CircleItem(String sImg, String sName, int sendNum, int acceptNum, String sContent, String sTime, double farNum, List<FavortItem> goodjobs, List<CommentItem> replys) {
        icon = sImg;
        nickName = sName;
        content = sContent;
        this.goodjobs = goodjobs;
